...
impl Rosu {
    fn new(ctx: &mut ggez::Context, mut cfg: config::Config) -> ggez::GameResult<Self> {
        ...
        let mut asset_mgr = assets::AssetManager::new();
        ...
        let game_state = game::Game::new(&mut asset_mgr.sound_bank);
...
impl ggez::event::EventHandler for Rosu {
    ...
    fn update(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult {
        ...
        self.game_state.update(ctx, &mut self.asset_mgr.sound_bank, dt);
    ...
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult {
        ...
        self.game_state.draw(ctx, render_request);
...
fn main() -> ggez::GameResult {
    ...
    let cb = ggez::ContextBuilder::new("Rosu", "Bowarc")
    ...
    let game = Rosu::new(&mut ctx, config)?;
