...
pub trait TElement: std::any::Any {
    ...
    */
    ...
    fn get_computed_size(&self, ctx: &mut ggez::Context) -> crate::maths::Vec2 {
        let sizev = self.get_size_value();

        crate::maths::Point::new(sizev.x().compute(ctx), sizev.y().compute(ctx))
    }

    fn get_computed_pos(
        &self,
        ctx: &mut ggez::Context,
        size_opt: Option<crate::maths::Vec2>,
    ) -> crate::maths::Point {
    ...
    fn get_computed_rect(&self, ctx: &mut ggez::Context) -> crate::maths::Rect {
        let size = self.get_computed_size(ctx);

        let position = self.get_computed_pos(ctx, Some(size));

        crate::maths::Rect::new_from_center(position, size, 0.)
    }
    ...
    */
    ...
    fn on_mouse_motion(
        &mut self,
        _position: crate::maths::Point,
        _delta: crate::maths::Point,
        _ctx: &mut ggez::Context,
    ) {
    }
    fn on_mouse_wheel(&mut self, _delta: crate::maths::Point, _ctx: &mut ggez::Context) {}
    fn on_key_down(
        &mut self,
